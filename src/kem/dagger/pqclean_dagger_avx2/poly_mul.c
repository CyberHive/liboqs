...
void PQCLEAN_DAGGER_AVX2_toom4_mul_A_by_B_eval(toom4_points_product *c_eval, const poly *a, const toom4_points *b_eval, int accumulate) {
    size_t i;
...
void PQCLEAN_DAGGER_AVX2_toom4_interp(poly *res, const toom4_points_product *c_eval) {
    size_t i;
