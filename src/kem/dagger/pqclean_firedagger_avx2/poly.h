...
void PQCLEAN_FIREDAGGER_AVX2_toom4_interp(poly *res_avx, const toom4_points_product *c_eval);

void PQCLEAN_FIREDAGGER_AVX2_toom4_eval(toom4_points *b_eval, const poly *b);

void PQCLEAN_FIREDAGGER_AVX2_toom4_mul_A_by_B_eval(toom4_points_product *c_eval, const poly *a_avx, const toom4_points *b_eval, int accumulate);
