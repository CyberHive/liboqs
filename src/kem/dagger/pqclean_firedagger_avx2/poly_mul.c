...
void PQCLEAN_FIREDAGGER_AVX2_toom4_mul_A_by_B_eval(toom4_points_product *c_eval, const poly *a, const toom4_points *b_eval, int accumulate) {
    size_t i;
...
void PQCLEAN_FIREDAGGER_AVX2_toom4_eval(toom4_points *b_eval, const poly *b) {
    size_t i;
    __m256i bw_avx[7 * L];
    __m256i r0_avx, r1_avx, r2_avx, r3_avx, r4_avx, r5_avx, r6_avx;
...
void PQCLEAN_FIREDAGGER_AVX2_toom4_interp(poly *res, const toom4_points_product *c_eval) {
    size_t i;
